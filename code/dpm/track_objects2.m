...
for i = start_frame:end_frame
    ...
    data = load(sprintf('clip2/bbox/clip2_%03d_bbox.mat', i));
    dets_cur = data.bbox;
    
    im_next = imread(fullfile(FRAME_DIR, sprintf('%03d.jpg', i+1)));
    data = load(sprintf('clip2/bbox/clip2_%03d_bbox.mat', i+1));
    dets_next = data.bbox;
